      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <button
            ...
            className="group relative md:w-52 shrink-0 h-40 md:h-auto bg-gray-100"
          ...
          >
            {thumbnail ? (
              ...
              <div className="flex h-full w-full items-center justify-center">
                <ImageOff className="h-8 w-8 text-gray-200" aria-hidden="true" />
              </div>
            )}
          </button>
          ...
          <div className="flex-1 p-4 md:p-5 flex flex-col gap-4">
            ...
            <div className="flex items-start justify-between gap-3 flex-wrap">
              <div className="flex items-start gap-2 min-w-0">
                <BedDouble className="h-5 w-5 text-blue-500 shrink-0 mt-0.5" aria-hidden="true" />
                <div>
                  <button
                    type="button"
                    onClick={() => setShowModal(true)}
            ...
            {/* Fiyat + Seç */}
            <div className="flex items-end justify-between gap-4 pt-2 border-t border-gray-50 mt-auto">
              <div>
                {hasDiscount && (
