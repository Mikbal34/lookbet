...
/**
 * <head> içine gömülen senkron script. Sırayla bakar:
 *   1) ?app=b2c | partner | 0 — tarayıcıda test için, tercihi kalıcılaştırır
 *      (?app=1 eski yazım, b2c'ye eşlenir)
 *   2) daha önce kalıcılaşmış tercih
 *   3) User-Agent imzası; yoksa React Native köprüsü (b2c varsayılır)
 *
 * Partner imzası önce kontrol ediliyor ki sıralamaya bağlı bir karışıklık
 * olmasın.
 */
...
var m=(s==='b2c'||s==='partner')?s:(s==='0'?null:t);
